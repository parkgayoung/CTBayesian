...
You can download the compendium as a zip from from this URL: <https://github.com/parkgayoung/CTBayesian/archive/master.zip>

Or you can install this compendium as an R package, CTBayesian, from GitHub with:
